...
## 追加機能（2025年7月時点）
**取引チャット機能**
商品の購入後、出品者と購入者がチャットでやり取りできます。画像付きメッセージや編集・削除も可能です。

**評価機能**
取引完了時、出品者・購入者がお互いを1〜5の評価でレビューできます（コメント付き）。

**通知機能**
新着メッセージがある取引には未読数が表示され、チャット一覧で確認できます。

**取引完了時のメール通知**
購入者が「取引を終了する」ボタンを押すと、出品者に通知メールが送信されます。
※開発環境では Mailhog または Mailtrap を使用。

**ダミーデータのシーディング対応**
以下のテストデータがシーディングで自動生成されます。初期動作確認に利用可能です。
